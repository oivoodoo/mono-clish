...
namespace Mono.Terminal
{
    ...
    public class LineEditor
    {
        ...
        public StringBuilder rendered_text;
...
// CUSTOMIZATION AKO
                ...
                {
                    InvokeHandleKeyDelegate(text.ToString());
                }
            }
            else
            {
        ...
        public class HandleKeyEventArgs : EventArgs
        {
            public String Text { get; set;}

            public HandleKeyEventArgs(String text)
            {
                Text = text;
            }
        }
        ...
        private void InvokeHandleKeyDelegate(String raw)
        {
            EventHandler local = TabKeyEvent;
            if (local != null)
            {
                local(this, new HandleKeyEventArgs(raw));
            }
            else
            {
                HandleChar('\t');
